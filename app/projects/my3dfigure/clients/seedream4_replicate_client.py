...
class Seedream4ReplicateClient:
        ...
        try:
            ...
            def upload_sync():
                with open(image_path, "rb") as image_file:
                    return self.client.files.create(image_file)
    ...
    async def generate_image(self, prompt, input_image_paths=None, seed=None, art_style=None, size="2K", width=None, height=None, aspect_ratio="3:4", sequential_image_generation="disabled", enhance_prompt=True, **kwargs):
        """

...
def _task_row(task: dict) -> str:
    ...
    if client_ip and ip_task_sequence:
        client_ip = (
            f'{client_ip} <span class="ip-task-sequence" '

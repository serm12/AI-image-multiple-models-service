...
def _task_row(task: dict) -> str:
    ...
    return (
        ...
        f'<td class="title-cell">{source_title_view}</td>'
...
<div class="panel"><table><thead><tr><th>任务 ID</th><th>状态</th><th>时间</th><th>总耗时</th><th>Provider</th><th>访客 IP</th><th>国家/地区</th><th>用户 / 转化状态</th><th>Title</th><th>来源页面</th><th>请求 URL</th><th>提示词</th><th>图片</th></tr></thead><tbody>{body}</tbody></table></div>
{pagination}

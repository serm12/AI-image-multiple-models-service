...
</style></head><body><main><header><div><h1>AI 图片生成记录</h1><div class="count">共 {_text(data['total'])} 条任务</div></div><div id="service-status" class="service-status checking"><span class="service-dot"></span><span class="service-text">状态检测中</span></div></header>

...
table{{width:100%;border-collapse:collapse;min-width:1735px;table-layout:fixed}}th,td{{padding:8px 7px;border-bottom:1px solid #edf0f5;text-align:left;vertical-align:middle}}th{{position:sticky;top:0;z-index:2;background:#f8fafc;font-size:12px;color:#64748b;white-space:nowrap}}tbody tr{{height:76px}}tbody tr:hover{{background:#fafcff}}
th:nth-child(1){{width:150px}}th:nth-child(2){{width:82px}}th:nth-child(3){{width:148px}}th:nth-child(4){{width:76px}}th:nth-child(5){{width:142px}}th:nth-child(6){{width:145px}}th:nth-child(7){{width:72px}}th:nth-child(8){{width:150px}}th:nth-child(9){{width:230px}}th:nth-child(10){{width:245px}}th:nth-child(11){{width:130px}}th:nth-child(12){{width:105px}}th:nth-child(13){{width:150px}}
